...
var CartService = /** @class */ (function () {
    ...
    CartService.prototype.isInCart = function (product) {
        // let includeProduct=false;
        // this.items.forEach(function(aproduct,aindex,aitems){
...
module.exports = "\n<h2>Product Details</h2>\n\n<div *ngIf=\"product\">\n  <h3>{{ product.name }}</h3>\n  <h4>{{ product.price | currency }}</h4>\n  <p>{{ product.description }}</p>\n  \n  <button *ngIf=\"!isInCart(product)\" (click)=\"addToCart(product)\">Buy</button>\n  \n  <button *ngIf=\"isInCart(product)\" disabled>Bought</button>\n</div>"
...
var ProductDetailsComponent = /** @class */ (function () {
    ...
    ProductDetailsComponent.prototype.isInCart = function (product) {
...
module.exports = __webpack_require__(/*! C:\Users\dell\Desktop\class\advancedweb\lab\web_2020-Lab2.1_Docs-Angular-master\Lab2.1_Docs-Angular\Lab2.1_Code-Angular_Demo\src\main.ts */"./src/main.ts");
